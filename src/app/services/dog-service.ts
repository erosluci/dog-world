...
export class DogService {
  ...
  getSingeBreed(id: number): Observable<Breed> {
    return this._http.get<Breed>(`${this._apiUrl}/breeds/${id}`, { headers: this._headers });
  }
  ...
  getRandomFact(): Observable<DogFact> {
    return this._http.get<DogFact>(this._randomDogApi, { headers: this._headers });
  }
}
